module Analysis
  ...
  class TopContent < Analyzer
    def call
      if connected_accounts.empty?
        return Outcome.needs_connection(reason: "Connect a social account and Prachar can find which of your posts perform best.")
      end
      ...
      Outcome.insufficient_data(reason: "Not enough published posts yet to identify a clear top performer.")
    end
  end
end
